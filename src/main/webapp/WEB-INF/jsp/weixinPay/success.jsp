...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/weixinPay/js/Scratch.js"></script>
</head>

<script>
    $(function () {
        var backUrl = '${weixinOrder.backUrl}';
...
<div class="zoomer">
    <div class="success">
        ...
        <ul class="recharge">
            ...
            <li>
                <label>实付:</label>
                <span class="rmb">${weixinOrder.total_fee}</span>
            </li>
            <li>
                <label>下单时间:</label>
                <span class="time">${weixinOrder.createTime}</span>
            </li>
        </ul>
        ...
        <script src="${pageContext.request.contextPath}/statics/weixinPay/js/Scratch.js"></script>
